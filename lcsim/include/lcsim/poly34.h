...
public:
    ...
    static void CSqrt( double x, double y, double &a, double &b) // returns:  a+i*s = sqrt(x+i*y)
    {
    ...
    static int SolveP4(double *x,double a,double b,double c,double d) {	// solve equation x^4 + a*x^3 + b*x^2 + c*x + d by Dekart-Euler method
        // move to a=0:
