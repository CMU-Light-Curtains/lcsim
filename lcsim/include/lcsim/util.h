...
Eigen::Matrix3f setEulerYPR(float eulerZ, float eulerY, float eulerX) {
...
Eigen::Matrix4f getTransformMatrix(float yaw, float pitch, float roll, float x, float y, float z){
    Eigen::Matrix4f transform_matrix;
    Eigen::Matrix3f rot_matrix = setEulerYPR(yaw,yaw,yaw);
...
void intersect(float A, float B, float C, float D, const cv::Vec3f& rayEq, cv::Vec4f& coord3D){
